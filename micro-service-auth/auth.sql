...
CREATE TABLE `oauth_client_details` (
  ...
  `resource_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户端资源',
  `client_secret` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户端秘钥',
  `scope` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户端范围',
  `authorized_grant_types` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户端认证方法',
  `web_server_redirect_uri` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户端跳转地址',
  `authorities` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `access_token_validity` int DEFAULT NULL COMMENT '客户端权限',
  `refresh_token_validity` int DEFAULT NULL COMMENT '刷新Token验证',
  `additional_information` longtext CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '客户端信息',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `archived` tinyint DEFAULT NULL,
  `trusted` tinyint DEFAULT NULL,
  `autoapprove` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '跳过认证码过程',
  PRIMARY KEY (`client_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='客户端';

-- ----------------------------
-- Records of oauth_client_details
-- ----------------------------
BEGIN;
INSERT INTO `oauth_client_details` VALUES ('client', 'RESOURCE', '$2a$10$TqQUuVvhYS8mT187KtVeBeOSmuWVB4yPea1pI0C7WB0ZbKAMbzexy', 'all', 'client_credentials,password,authorization_code,implicit,refresh_token', 'https://www.baidu.com', '', 7200, 259200, '{}', '2020-11-27 07:13:38', 0, 0, 'false');
COMMIT;
...
CREATE TABLE `system_role_authority_relation` (
  ...
  KEY `system_role_authority_relation_authority_fk` (`authority_id`) USING BTREE,
...
-- ----------------------------
BEGIN;
INSERT INTO `system_user` VALUES (1, 'admin', '$2a$10$NMsQkyxk6fAdqIQX05uS1Oyn2nZz9vF3I2mGPnkGyEiNCLC9HbO8a', '/static/Administrator.jpg', '肖宇', '超级管理员', '794763733@qq.com', '18106666986', '127.0.0.1', 0, 0, '2020-10-24 09:36:43', '2020-10-24 09:36:47', '2020-11-16 08:25:31');
