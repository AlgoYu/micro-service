...
) ENGINE=InnoDB AUTO_INCREMENT=393 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='config_info';
...
INSERT INTO `config_info` VALUES (321, 'service.default.grouplist', 'SEATA_GROUP', '127.0.0.1:8091', 'c32ce0d3e264525dcdada751f98143a3', '2021-01-21 09:18:04', '2021-01-21 09:18:04', NULL, '172.100.0.1', '', '', NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `config_info` VALUES (350, 'store.db.url', 'SEATA_GROUP', 'jdbc:mysql://172.100.0.2:3306/seata?useUnicode=true&rewriteBatchedStatements=true', '481fe5cf063f65c657c53dcd764317b0', '2021-01-21 09:18:05', '2021-01-21 09:18:05', NULL, '172.100.0.1', '', '', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=662 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
BEGIN;
INSERT INTO `his_config_info` VALUES (15, 661, 'MICRO-AUTH-SERVICE.yaml', 'DEV', '', 'spring:\n  # 允许bean覆盖\n  main:\n    allow-bean-definition-overriding: true\n  # 链路追踪\n  zipkin:\n    base-url: http://localhost:9411\n    sleuth:\n      sampler:\n        probability: 1\n  cloud:\n    # 注册中心\n    nacos:\n      discovery:\n        server-addr: 127.0.0.1:8848\n    # 熔断限流降级\n    sentinel:\n      transport:\n        dashboard: 127.0.0.1:8858\n        port: 8719\n  # 数据源\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/micro_service?useUnicode=true&useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true\n    username: root\n    password: 123456\n    # 连接池\n    druid:\n      # 最小空闲\n      min-idle: 5\n      # 最大存活连接\n      max-active: 20\n      # 初始化连接数\n      initial-size: 5\n      # 配置监控服务器\n      stat-view-servlet:\n        #是否允许开启监控\n        enabled: true\n        #是否允许重置监控数据\n        reset-enable: true\n        #druid访问路径\n        url-pattern: /druid/*\n      # 监控统计过滤器\n      filters: stat,wall,log4j2\n      # 检查关闭空闲连接的时间周期\n      time-between-eviction-runs-millis: 6000\n      # mergeSql，慢SQL记录\n      connect-properties: druid.state.mergeSql=true\n# 暴露端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n# Mybatis Plus\nmybatis-plus:\n  mapper-locations: classpath*:/mapper/*.xml\n  type-enums-package: cn.machine.geek.enums\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl', 'f1c7f782ead45bb2d4a4e3a069999db4', '2021-01-21 15:03:19', '2021-01-21 15:03:19', NULL, '172.100.0.1', 'U', '');
COMMIT;
