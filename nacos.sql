...
INSERT INTO `config_info` VALUES (15, 'MICRO-AUTH-SERVICE.yaml', 'DEV', 'spring:\n  # 允许bean覆盖\n  main:\n    allow-bean-definition-overriding: true\n  # 链路追踪\n  zipkin:\n    base-url: http://localhost:9411\n    sleuth:\n      sampler:\n        probability: 1\n  cloud:\n    # 注册中心\n    nacos:\n      discovery:\n        server-addr: 127.0.0.1:8848\n    # 熔断限流降级\n    sentinel:\n      transport:\n        dashboard: 127.0.0.1:8858\n        port: 8719\n  # 数据源\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/micro_service?useUnicode=true&useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true\n    username: root\n    password: 123456\n    # 连接池\n    druid:\n      # 最小空闲\n      min-idle: 5\n      # 最大存活连接\n      max-active: 20\n      # 初始化连接数\n      initial-size: 5\n      # 配置监控服务器\n      stat-view-servlet:\n        #是否允许开启监控\n        enabled: true\n        #是否允许重置监控数据\n        reset-enable: true\n        #druid访问路径\n        url-pattern: /druid/*\n      # 监控统计过滤器\n      filters: stat,wall,log4j2\n      # 检查关闭空闲连接的时间周期\n      time-between-eviction-runs-millis: 6000\n      # mergeSql，慢SQL记录\n      connect-properties: druid.state.mergeSql=true\n# 暴露端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n# Mybatis Plus\nmybatis-plus:\n  mapper-locations: classpath*:/mapper/*.xml\n  type-enums-package: cn.machine.geek.enums\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl', 'f1c7f782ead45bb2d4a4e3a069999db4', '2021-01-18 09:41:05', '2021-01-22 05:01:25', NULL, '172.100.0.1', '', '', '认证中心配置', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (27, 'MICRO-CENTER-SERVICE.yaml', 'DEV', 'spring:\n  # 排除自动配置\n  autoconfigure:\n    exclude: org.springframework.cloud.security.oauth2.SpringCloudSecurityAutoConfiguration\n  # 允许bean覆盖\n  main:\n    allow-bean-definition-overriding: true\n  # 链路追踪\n  zipkin:\n    base-url: http://localhost:9411\n    sleuth:\n      sampler:\n        probability: 1\n  cloud:\n    # 注册中心\n    nacos:\n      discovery:\n        server-addr: 127.0.0.1:8848\n    # 熔断限流降级\n    sentinel:\n      transport:\n        dashboard: 127.0.0.1:8858\n        port: 8719\n  # 数据源\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://127.0.0.1:3306/micro_service?useUnicode=true&useSSL=false&characterEncoding=utf8&allowPublicKeyRetrieval=true\n    username: root\n    password: 123456\n    # 连接池\n    druid:\n      # 最小空闲\n      min-idle: 5\n      # 最大存活连接\n      max-active: 20\n      # 初始化连接数\n      initial-size: 5\n      # 配置监控服务器\n      stat-view-servlet:\n        #是否允许开启监控\n        enabled: true\n        #是否允许重置监控数据\n        reset-enable: true\n        #druid访问路径\n        url-pattern: /druid/*\n      # 监控统计过滤器\n      filters: stat,wall,log4j2\n      # 检查关闭空闲连接的时间周期\n      time-between-eviction-runs-millis: 6000\n      # mergeSql，慢SQL记录\n      connect-properties: druid.state.mergeSql=true\n# 暴露端点\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \'*\'\n# Mybatis Plus\nmybatis-plus:\n  mapper-locations: classpath*:/mapper/*.xml\n  type-enums-package: cn.machine.geek.enums\n  configuration:\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl\n# 分布式事务配置\nseata:\n  tx-service-group: machine_geek\n  enable-auto-data-source-proxy: true\n  registry:\n    type: nacos\n    nacos:\n      server-addr: 127.0.0.1:8848\n      namespace:\n      group: SEATA_GROUP\n      application: SEATA-SERVER\n  config:\n    type: nacos\n    nacos:\n      server-addr: 127.0.0.1:8848\n      namespace:\n      group: SEATA_GROUP\n# 日志级别\nlogging:\n  level:\n    org.springframework.boot.autoconfigure.security: WARN', '4b3f67e70466f85eb492949b00cce09f', '2021-01-20 06:57:35', '2021-01-22 10:48:43', NULL, '172.100.0.1', '', '', '中心服务配置', '', '', 'yaml', '');
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=680 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';
